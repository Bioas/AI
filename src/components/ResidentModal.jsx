          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Input value={lineUserId} onChange={e => setLineUserId(e.target.value)}
                placeholder="พิมพ์ LINE User ID (U...)" />
              <select value={lineUserId} onChange={e => setLineUserId(e.target.value)}
                ...
                <option value="">— เลือกจากที่มี —</option>
            ...
            {lineUserId && lineUserId.startsWith('U') && (
              <p className="text-xs text-lime-600 mt-1">✓ LINE User ID: {lineUserId}</p>
            )}
          </div>
        </div>
